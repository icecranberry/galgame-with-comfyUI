...
{"title":"事件标题（≤8字，口语感叹。关键：从你刚写完的事件场景里抓最戳人的那个瞬间，用角色第一反应的口吻喊出来——不是给事件'取名'，是把事件核心直接说出来。正确示例（假设场景是捡到奇怪包裹）：包裹在动……|谁寄来的？！|没写寄件人|打开还是不打开。错误：神秘包裹降临|意外来客|日常中的异物——这些是在概括事件类型，不是在喊出这个瞬间。禁止通用感叹如'天哪''不是吧'——必须带上具体的事件信息）","description":"场景叙述（紧密第三人称，80-150字。从感官细节切入，展开角色的即时反应，结尾卡在选择点上。铁律：不使用'你'字，始终用ta/她/他。重要：事件方向只是一个出发点——具体场景必须由角色人格和世界观驱动，不要产出可以被复制粘贴到其他角色身上的通用故事）","prompt":"画面描述（英文。${imagePromptInstruction}）${multiPersonImageNote}","choiceA":"选项A（具体行动，8-15字。与B形成真正的行动对比）","choiceB":"选项B（与A形成真正的行动对比——介入vs抽身/直接vs迂回/面对vs回避/现在vs稍后。8-15字）"}
...
- **标题风格**：标题不是你写完场景后给事件"取个名字"——是你写完场景后最想替角色喊出来的那句话。从你刚写的场景里抓最戳人的那个瞬间（角色看到奇怪东西的第一反应、事情发生时脱口而出的那句、心跳漏一拍时闪过的念头），直接说出来。禁止用标题"概括"事件类型（如"神秘包裹降临"）、禁止万能感叹（如"天哪""不是吧"——必须带上这个事件的具体信息，让人一看标题就知道发生的是什么事）。`;
