...
.ded-act.edit:hover { background: var(--bg-hover); color: var(--text-primary); }
.ded-act.trash { background: color-mix(in srgb, var(--danger) 6%, transparent); color: var(--danger); font-size: 13px; }
.ded-act.trash:hover { background: var(--danger); color: var(--on-accent); }
