        ...
        <div class="fs-content">
          ...
          <div class="fs-stage">
            ...
            <Transition name="fs-reveal">
              <div v-if="revealVisible && revealedItem" class="fs-item">
                <div class="fs-item-float">
                  ...
                  <div class="fs-item-image">
                    <img v-if="revealedItem.image_url" :src="revealedItem.image_url" alt=""/>
                    <ItemFallbackIcon v-else/>
                  </div>
                </div>
                <div class="fs-item-name-row">
                  <span class="fs-item-name">{{ revealedItem.name }}</span>
                </div>
                <p class="fs-item-desc">{{ revealedItem.description }}</p>
              </div>
            </Transition>
          </div>
          <div v-if="revealVisible" class="fs-actions">
            <linshe-button variant="primary" size="lg" :loading="collecting" @click="onCollectFromReveal">收入背包</linshe-button>
          </div>
        </div>
      </div>
    </Transition>
