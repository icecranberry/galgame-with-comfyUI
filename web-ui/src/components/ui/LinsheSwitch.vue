...
.ls-switch__track {
  ...
  box-shadow: 0 var(--depth) 0 var(--border), inset 0 1px 0 color-mix(in srgb, var(--bg-secondary) 88%, transparent);
  transition:
...
.ls-switch--on .ls-switch__track {
  ...
  box-shadow: 0 var(--depth) 0 var(--accent-hover), inset 0 1px 0 color-mix(in srgb, var(--bg-secondary) 38%, transparent);
}
